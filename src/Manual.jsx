...
Por ejemplo: un componente puede tener un estado \`text\` que guarda el valor de un input y otro estado \`updated\` para almacenar el texto final tras una acción, como pulsar un botón.  
...
function Manual() {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 900, margin: "0 auto", fontFamily: "Arial, sans-serif", lineHeight: 1.6 }}>
